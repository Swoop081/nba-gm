...
'Josh Giddey':C('CHI',25,3,75),'Nic Claxton':C('CHI',23.320738,2,44.420458),'Norman Powell':C('CHI',21.5,2,21.5),'Patrick Williams':C('CHI',18,3,36),'Isaac Okoro':C('CHI',11.814814,1,11.814814),'Caleb Wilson':C('CHI',10.68372,4,21.90168),'Jalen Smith':C('CHI',9.428571,1,9.428571),'Zach Collins':C('CHI',8.5,2,17),'Tre Jones':C('CHI',8,2,8),'Rob Dillingham':C('CHI',6.88932,2,6.88932),'Matas Buzelis':C('CHI',5.71536,2,5.71536),'Noa Essengue':C('CHI',5.7012,3,5.7012),'Dailyn Swain':C('CHI',4.96548,4,10.17924),'Leonard Miller':C('CHI',2.406205,1,2.406205),'Kam Jones':C('CHI',1.075459,1,1.075459),'Jaylin Sellers':C('CHI',0.678882,1,0.091),'Tobe Awaka':C('CHI',0.678882,1,0.091)
};
