...
// Sacramento Kings
'Zach LaVine':C('SAC',48.96738,1,48.96738),'Domantas Sabonis':C('SAC',45.472,2,94.08),"De'Andre Hunter":C('SAC',24.910714,1,24.910714),'Keegan Murray':C('SAC',24.137936,5,140),'Malik Monk':C('SAC',20.190035,2,20.190035),'Darius Acuff Jr.':C('SAC',8.02164,4,16.44456),'Precious Achiuwa':C('SAC',5.477,2,11.22785),'Nique Clifford':C('SAC',3.2634,3,3.2634),'Daeqwon Plowden':C('SAC',2.449421,2,5.113822),'Ben Simmons':C('SAC',2.449421,1,null),'Maxime Raynaud':C('SAC',2.150917,2,2.150917),'Jonathan Mogbo':C('SAC',2.406205,1,2.406205),'Adam Flagler':C('SAC',0.678882,1,0.091),'Dylan Cardwell':C('SAC',0.678882,1,0.091),
// San Antonio Spurs
"De'Aaron Fox":C('SAS',49.8,4,223.104),'Devin Vassell':C('SAS',27,3,78.652174),'Keldon Johnson':C('SAS',17.5,1,17.5),'Victor Wembanyama':C('SAS',16.868246,6,211.748246),'Tobias Harris':C('SAS',15.044,2,30.8402),'Julian Champagnie':C('SAS',13.888889,3,45),'Dylan Harper':C('SAS',12.98904,3,12.98904),'Luke Kornet':C('SAS',10.45,3,13),'Stephon Castle':C('SAS',10.01592,2,10.01592),'Harrison Barnes':C('SAS',8,1,8),'Carter Bryant':C('SAS',5.14536,3,5.14536),'Jayden Quaintance':C('SAS',3.90276,4,8.00064),'Jordan McLaughlin':C('SAS',2.449421,1,2.449421),'David Jones Garcia':C('SAS',0.678882,1,0.091),
// Toronto Raptors
